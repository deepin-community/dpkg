...
readonly cmd_src=dpkg
readonly orig_bin=dpkg.real

readonly conf_file="/usr/share/dpkg/dpkg-immutable.cfg"
readonly override_conf="/etc/dpkg/dpkg-immutable.cfg"
